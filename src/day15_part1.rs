...
mod tests {
    ...
    #[test]
    fn test_total() {
        assert_eq!(get_answer(include_str!("../assets/day15_input_demo1.txt")),Some(436));
        assert_eq!(get_answer("1,3,2"),Some(1));
        assert_eq!(get_answer("2,1,3"),Some(10));
        assert_eq!(get_answer("1,2,3"),Some(27));
        assert_eq!(get_answer("2,3,1"),Some(78));
        assert_eq!(get_answer("3,2,1"),Some(438));
        assert_eq!(get_answer("3,1,2"),Some(1836));
        assert_eq!(get_answer(include_str!("../assets/day15_input.txt")), Some(1696));
    }
}
